...
>(({ className, ...props }, ref) => (
  <Input
    className={cn(
      "border-0 focus-visible:ring-0 focus-visible:ring-offset-0 shadow-none focus-visible:ring-blue-0",
      className
    )}
    {...props}
    ref={ref}
    ...
    >
      ...
      <PopoverTrigger asChild>
        ...
        >
          ...
          />
          <span className="text-sm text-gray-950 font-medium">{`+${RPNInput.getCountryCallingCode(
            selectedCountry
          )}`}</span>
