...
export default function ForgotPasswordStep() {
    ...
    const onSubmit: SubmitHandler<ForgotPasswordValues> = async (data) => {
        sendOtp(data, {
            onSuccess: (response) => {
                ...
                toast.custom(() => <AppToaster massage={response as string} />, { duration: 1000 });
    ...
    return (
        <FormLayout label="Forgot Password" resetPassword={true}>
            {/* Description */}
            <p className="pb-6 mb-4 mt-2.5 text-gray-500">Don’t worry, we will help you recover your account.</p>
