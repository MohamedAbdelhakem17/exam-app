...
export default function ExamCard({ exam, link }: ComponentProps) {
  return (
    <li className="border border-gray-200 rounded-lg ">
      {/* Exam Questions Link */}
      <Link
        href={link}
        className="flex items-center justify-between p-4 bg-blue-50 flex-col sm:flex-row gap-4 rounded-lg hover:bg-blue-100 transition"
      >
        {/* Exam title */}
        <h3>
          {/* Label */}
